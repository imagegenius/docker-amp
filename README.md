...
Simply pulling `ghcr.io/imagegenius/amp:ubuntu` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' ghcr.io/imagegenius/amp:ubuntu`
...
docker build \
  --no-cache \
  --pull \
  -t ghcr.io/imagegenius/amp:ubuntu .
```

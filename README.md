...
Simply pulling `ghcr.io/hydazz/amp:latest` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
services:
  amp:
    image: ghcr.io/hydazz/amp:latest
    container_name: amp
...
* Update the image: `docker pull ghcr.io/hydazz/amp:latest`
